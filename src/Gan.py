...
from src.Model import  Embedin, Embedout, Encoder, Decoder, Attention, Autoencoder, Discriminator, Discriminator2, Lstm
import torch
...
def get_dictionary():
    ...
    return idx_five_seq, idx_seven_seq, word2idx, idx2word
...
def get_model():
    ...
    ae5 = Autoencoder(enc,dec5,atten5,embedout,13)
    ae7 = Autoencoder(enc,dec7,atten7,embedout,17)
    
    discriminator = Discriminator(hidden_size)
    discriminator2 = Discriminator2(vocab_size,embed_size,hidden_size)
    
    seq2seq57 = Autoencoder(enc,dec7,atten5,embedout,17)
    seq2seq75 = Autoencoder(enc,dec5,atten7,embedout,13)
...
def save_model():   
    torch.save(ae5.state_dict(),'../models/ae5_2dis.pt')
    torch.save(ae7.state_dict(),'../models/ae7_2dis.pt')
    torch.save(discriminator.state_dict(),'../models/discriminator_2disc.pt')
    torch.save(discriminator2.state_dict(),'../models/discriminator2_2disc.pt')

def main():
    idx_five_seq, idx_seven_seq, word2idx, idx2word = get_dictionary()
